                    ...
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('auth/registrationTanpaVerifikasiEmail'); ?>">
                            ...
                            <div class="form-group">
                                <input required type="text" class="form-control form-control-user" id="email" name="email" placeholder="Alamat E-mail" value="<?= set_value('email'); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input required type="password" class="form-control form-control-user" id="password2" name="password2" placeholder="Ulangi Password">
                                </div>
                            </div>
