                                        ...
                                        <table class="table table-sm">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="35%" rowspan="5"> <img src="<?= base_url('assets/img/cpmi/') . $lokasi->image ?>"  alt="Profile Picture" 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td colspan="3"><?= $lokasi->nama_negara ?></td>
                                                </tr>
...
<!-- Scroll to Top Button-->
   ...
   crossorigin=""></script>
    ...
    <script>
        ...
        .addTo(map)
        .bindPopup('<center><div class="container px-0 py-0"><img src="<?= base_url("assets/img/cpmi/") . $lokasi->image ?>" alt="profile" class=" img-responsive" style="padding-bottom: 15px; width: 100px; height: 90px; object-fit:cover;  border-radius: 10%">'+
