                ...
                <div class="card-header py-2 ">
                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between mb-0">
                            <p style="font-family:'helvetica';font-size:15;">Rincian Data<b> <?= $lokasi->nama_pmi ?></b>  <?= $title; ?> <b> <?= date('Y'); ?></b></p>
                        ...
                        <div>
                            <form action="<?= base_url('cpmi/print/' . $lokasi->id); ?>" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <table class="table table-sm">
                                            <thead>
                                                <tr>
                                                <th colspan="4" class="text-center">Data CPMI <?= date('Y'); ?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="5%">:</td>
                                                    <td width="40%"><?= $lokasi->nama_pmi ?></td>
                                                    <td width="35%" rowspan="5"> 

                                                    <?php if ($lokasi->image != null) { ?>
                                                            <center><img src="<?= base_url("assets/img/cpmi/") . $lokasi->image ?> "alt="profile" class=" img-responsive" style="width: 180px; height: 220px; object-fit: cover;"></center>
                                                    <?php }else{ ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td ><?php if ($lokasi->jenis_kelamin == 'L') {
                                                            echo 'Laki-laki';
                                                        } else if ($lokasi->jenis_kelamin == 'P'){ 
                                                            echo 'Perempuan';
                                                        } else 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td><?= $lokasi->tempat_lahir ?>, <?= $lokasi->tanggal_lahir ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td><?= $lokasi->pendidikan_formal ?></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Kabupaten/kota</th>
                                                    <td>:</td>
                                                    <td><?= $lokasi->nama_kabupaten ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td colspan="3"><?= $lokasi->jabatan ?></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Perusahaan </th>
                                                    <td>:</td>
                                                    <td colspan="3"><?= $lokasi->perusahaan ?></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Pengguna Jasa</th>
                                                    <td>:</td>
                                                    <td colspan="3"><?= $lokasi->pengguna_jasa ?></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Alamat Pengguna Jasa</th>
                                                    <td>:</td>
                                                    <td colspan="3"><?= $lokasi->alamat_pengguna_jasa ?></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Gaji</th>
                                                    <td>:</td>
                                                    <td colspan="3"><?= $lokasi->gaji ?></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Paspor</th>
                                                    <td>:</td>
                                                    <td colspan="3"><?= $lokasi->paspor ?></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Kode Pesawat</th>
                                                    <td>:</td>
                                                    <td colspan="3"><?= $lokasi->kode_pesawat ?></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Negara tujuan</th>
                                                    <td>:</td>
                                                    <td colspan="3"><?= $lokasi->nama_negara ?>&nbsp; <img src="<?= base_url("assets/img/img-country-flag/") . $lokasi->flag ?>" alt="profile" class=" img-responsive" style="padding-bottom: 15px; width: 30px;"></td>
                                                </tr>
   ...
   crossorigin=""></script>
    ...
    <script>
        ...
        .bindPopup(`<center><div class="container px-0 py-0">
                    <?php if ($lokasi->image != null) { ?>
                        <center><img src="<?= base_url("assets/img/cpmi/") . $lokasi->image ?> "alt="profile" class=" img-responsive" style="padding-bottom: 15px; width: 100px; height: 90px; object-fit:cover;  border-radius: 10%"></center>
                    <?php }else{ ?>
                    ...
                    <small><p style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden; font-weight:bold; padding:0px; margin:0px;"><span class="badge badge-pill badge-info"><i>CPMI</i></span>&nbsp;<?= $lokasi->nama_pmi ?> </p></small> </div></center> `)
        .openPopup();
