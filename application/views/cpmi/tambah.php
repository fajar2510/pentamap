                            ...
                            <form action="<?= base_url('cpmi/tambah'); ?>" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control" required id="alamat" placeholder="Alamat Lengkap. . . " name="alamat" rows="2"></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="lokasi" required id="lokasi" class="form-control" aria-describedby="lokasiHelp">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-3">
                                            <input class="form-control" required type="date" value="2000-07-31" id="tanggal_lahir" name="tanggal_lahir">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="jabatan" required id="pendidikan" class="form-control">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="pendidikan" required id="pendidikan" class="form-control">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" required class="form-control" id="gaji" placeholder="Masukkan Nominal Gaji" name="gaji">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" required class="form-control" id="paspor" placeholder="Nomor Paspor" name="paspor">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" required class="form-control" id="kode_pesawat" placeholder="Kode Pesawat" name="kode_pesawat">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="form-control" required id="alamat_pengguna_jasa" placeholder="Alamat Lengkap. . . " name="alamat_pengguna_jasa" rows="2"></textarea>
