                ...
                <div class="card-header py-2 ">
                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between mb-0">
                            <p style="font-family:'helvetica';font-size:15;">Rincian Data<b> <?= $lokasi->nama_tka ?></b>  <?= $title; ?> <b> <?= date('Y'); ?></b></p>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <table class="table table-sm">
                                            <thead>
                                                <tr>
                                                <th colspan="4" class="text-center">Data TKA <?= date('Y'); ?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                ...
                                                <tr>
                                                    <th scope="row">No. RPTKA</th>
                                                    <td>:</td>
                                                    <td><?= $lokasi->no_rptka ?></td>
                                                    <td colspan="2"> <?= $lokasi->masa_rptka ?></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">No. IMTA</th>
                                                    <td>:</td>
                                                    <td><?= $lokasi->no_imta ?></td>
                                                    <td colspan="2"><?= $lokasi->masa_imta ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                         <hr>
