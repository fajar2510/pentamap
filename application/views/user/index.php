                    ...
                    <div class="modal-body"  style="color:#5b5b5b;">
                        ...
                        <div class="form-group row">
                            <label for="image" class="col-sm-3 col-form-label">Unggah Foto Profil</label>
                                <div class="col-sm-3">
                                <div class="foto2"><img src="<?= base_url('assets/img/profile/') . $user['image'] ?>" class="img-thumbnail" alt="Profile Picture" style="width: 180px; height: 180px; object-fit: cover;"></div>
