                ...
                <div class="card-header py-2 ">
                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center justify-content-between mb-0">
                            <p style="font-family:'helvetica';font-size:15;">Rincian Data<b> <?= $lokasi->nama ?></b>  <?= $title; ?> <b> <?= date('Y'); ?></b></p>
                        ...
                        <div>
                            <form action="<?= base_url('pmi/print/' . $lokasi->id); ?>" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <table class="table table-sm">
                                            <thead>
                                                <tr>
                                                <th colspan="4" class="text-center">Data PMIB <?= date('Y'); ?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td><?= $lokasi->jenis_pekerjaan ?></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">Berangkat dari</th>
                                                    <td>:</td>
                                                    <td><?= $lokasi->berangkat_melalui ?></td>
                                                </tr>
                                                <tr>
