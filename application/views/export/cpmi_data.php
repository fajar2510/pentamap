...
<body>
    ...
    <p align="left"><small><b>Nama Perusahaan &nbsp; : <?= $row['nama_perusahaan'] ?></b> <br> <b>Alamat &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?= $row['alamat'] ?></b> <br> <b>Negara Tujuan_&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?= $row['negara_penempatan'] ?></b> <br> <b>Bulan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php
    ...
    <table width="100%">
        <thead>
            ...
            <tr align="center">
                ...
                <td align="center" style="font-weight: bold; font-size: small">Jabatan</td>
        ...
        <tbody align="center" class="items">
            ...
            <?php foreach ($semua_data_cpmi as $row) : ?>
                <tr>
                    <th><?= $i; ?></th>
                    <td> <small> <b><?= $row['nama_pmi'] ?> </b> <br> <?= $row['alamat'] ?> <br> <?= $row['tempat_lahir'] ?>, <?= $row['tanggal_lahir'] ?></small></td>
