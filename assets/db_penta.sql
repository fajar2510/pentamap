...
--
-- Table structure for table `tb_pmi`
--
...
CREATE TABLE `tb_pmi` (
  ...
  `negara_bekerja` varchar(50) NOT NULL,
  `jenis_pekerjaan` varchar(80) NOT NULL,
  `berangkat_melalui` varchar(50) NOT NULL,
  `pengirim` varchar(50) NOT NULL,
  `lama_bekerja` varchar(30) NOT NULL,
  `image` varchar(120) NOT NULL,
  `status` enum('PROSEDURAL','NON-PROSEDURAL') NOT NULL,
...
(5, 99, 'Pengaturan Sub Menu', 'menu/submenu', 'fas fa-fw fa-bars ', 1),
